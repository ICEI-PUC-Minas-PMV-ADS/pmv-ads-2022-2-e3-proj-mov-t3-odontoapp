        ...
        <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
                <View style={styles.contentInfo}>
                    ...
                    <Text style={styles.infoSubtitle}>Digite o e-mail associado à sua conta e iremos te enviar um link para redefinição da senha.</Text>
                </View>
                <View style={styles.contentForm}>
                    <InputForm label={'E-mail'}/>
                    <BotaoPrimario label={'Enviar'} onPress={()=>{navigation.navigate('Reenvio')}}/>
                </View>
            </View>
